...
- Design of a project decomposition plan and low-fidelity mockup of dashbord design for visualization of insights.
  ...
  -  [Analysis of Customer Segmentation and Purchasing Behavior(click on edit button to viw full report)](https://public.tableau.com/views/UPDATTEDFINALPROJECT-YESUSENA/ZamatosCustomers?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) 
